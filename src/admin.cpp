...
int main()
{
    ...
    try
    {
	    ...
	    if(!indexPage.SetTemplateFile("templates/admin_index.htmlt"))
	    {
			...
			log.Write(ERROR, "main: ERROR: template file was missing");
	    ...
	    if(db.Connect(DB_NAME, DB_LOGIN, DB_PASSWORD) < 0)
	    {
	        ...
	        log.Write(ERROR, "main: ERROR: Can not connect to mysql database");
	        return(1);
	    }
	    ...
	    if(act == "admin_chat_get_cnx_list")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_chat_get_cnx_list: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_chat_get_cnx_list: end");
		    }
	    }
	    if(act == "admin_chat_get_presence_cache")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_chat_get_presence_cache: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_chat_get_presence_cache: end");
		    }
	    }
	    if(act == "admin_get_user_list")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_user_list: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_user_list: end");
		    }
	    }
	    if(act == "admin_get_companies_duplicates")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_companies_duplicates: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_companies_duplicates: end");
		    }
	    }
	    if(act == "admin_get_pictures_lostindb")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_pictures_lostindb: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_pictures_lostindb: end");
		    }
	    }
	    ...
	    if(act == "admin_get_recommendation_adverse")
	    {
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_recommendation_adverse: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == admin_get_recommendation_adverse: end");
		    }
	    }
	    ...
	    if(act == "AJAX_getUserList")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getUserList: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getUserList: end");
		    }
	    ...
	    if(act == "AJAX_getCompaniesDuplicates")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getCompaniesDuplicates: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getCompaniesDuplicates: end");
		    }
	    ...
	    if(act == "AJAX_getPicturesLostindb")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getPicturesLostindb: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getPicturesLostindb: end");
		    }
	    ...
	    if(act == "AJAX_getRecommendationAdverse")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getRecommendationAdverse: begin");
		    }
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_getRecommendationAdverse: end");
		    }
	    ...
	    if(act == "AJAX_setRecommendationPotentialAdverse")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_setRecommendationPotentialAdverse: begin");
		    }
		    ...
		    {
		    	CLog	log;
		    	log.Write(DEBUG, "main: act == AJAX_setRecommendationPotentialAdverse: ERROR:", db.GetErrorMessage());
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_setRecommendationPotentialAdverse: end");
		    }
	    ...
	    if(act == "AJAX_setRecommendationClean")
	    {
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_setRecommendationClean: begin");
		    }
		    ...
		    {
		    	CLog	log;
		    	log.Write(DEBUG, "main: act == AJAX_setRecommendationClean: ERROR:", db.GetErrorMessage());
		    ...
		    {
		        CLog	log(ADMIN_LOG_FILE_NAME);
		        log.Write(DEBUG, "main: act == AJAX_setRecommendationClean: end");
		    }
